    ...
    var body: some View {
        ZStack {
            ...
            VStack(alignment: .center, spacing: 80) {
                ...
                HStack {
                    ...
                    Text("SLOT MACHINE")
                        .font(.system(size: 30))
                        .fontWeight(.black)
                        .shadow(color: .orange, radius: 2, y: 3)
            ...
            .alert(item: $showingAlert) { alert -> Alert in
                        ...
                        switch alert {
                        case .success:
                            return  Alert(title: Text("Yayy!! You Won 🥳🤑"), message: Text("Born With The Charm"), dismissButton:.cancel())

                        case .failure:
                            return  Alert(title: Text("Oops!!, Try Again 😮‍💨☹️"), message: Text("Better Luck Next Time"), dismissButton:.cancel())
                        }
                    }
            }
        }
